...
# --- Deriv API Connection Engine ---
async def fetch_deriv_data():
    # Fetch App ID from environment variable (Defaults to 1089 for testing/demo data)
    ...
    async with websockets.connect(url) as websocket:
        ...
        # Structure incoming JSON to standard DataFrame format
...
async def main():
    print("Connecting to Deriv WebSockets...")
    ...
    if df is not None and not df.empty:
        ...
        print("Failed to pull market history.")
